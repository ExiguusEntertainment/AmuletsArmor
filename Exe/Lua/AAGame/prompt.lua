...
prompt.displayMessage = function(message)
	...
	form:addGraphic{id="background", x=27, y=79, picName="UI/PROMPT/PMPTMESG.png"};
	form:addButton{id="ok", x=131, y=98, picName="UI/PROMPT/OK.png",
...
prompt.forString = function(message, maxLength)
	...
	form:addGraphic{id="background", x=27, y=71, picName="UI/PROMPT/PMPTSTRN.png"};
	form:addButton{id="ok", x=89, y=108, picName="UI/PROMPT/ACCEPT.png", 
		scankey2=keyboard.scankeys.KEY_SCAN_CODE_ENTER};
	form:addButton{id="cancel", x=173, y=108, picName="UI/PROMPT/CANCEL.png", 
...
prompt.question = function(question, default)
	...
	form:addGraphic{id="background", x=27, y=79, picName="UI/PROMPT/PMPTBOOL.png"};
	form:addButton{id="yes", x=89, y=98, picName="UI/PROMPT/YES.png", 
		scankey2=keyboard.scankeys.KEY_SCAN_CODE_ENTER};
	form:addButton{id="no", x=173, y=98, picName="UI/PROMPT/NO.png", 
		scankey2=keyboard.scankeys.KEY_SCAN_CODE_ESC};
